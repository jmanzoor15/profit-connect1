...
import { defineComponent, getCurrentInstance, markRaw, watch, watchEffect, reactive, onUnmounted, ref, isRef, createTextVNode, resolveComponent, h, provide, inject, onMounted, computed, toRef, onBeforeUnmount, Suspense, nextTick, triggerRef, isReactive } from 'vue';
    ...
    async setup(props) {
        ...
        const formRenders = computed(() => {
            return filteredFormNames.map((form) => {
                ...
                return h('div', {}, activeTab.value === form.id
                    ? [
                        h('div', {
